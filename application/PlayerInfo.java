...
public class PlayerInfo extends Application {
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("Players' information");
        stage.setWidth(600);
        stage.setHeight(300);

        final Label label = new Label("Players' information");
        label.setFont(new Font("Arial", 20));

        TableColumn<Map, String> name = new TableColumn<>("name");
        TableColumn<Map, String> cash = new TableColumn<>("cash");
        TableColumn<Map, String> deposit = new TableColumn<>("deposit");
        TableColumn<Map, String> coupon = new TableColumn<>("coupon");
        TableColumn<Map, String> houseNum = new TableColumn<>("houseNum");
        TableColumn<Map, String> stock = new TableColumn<>("stock");
        TableColumn<Map, String> property = new TableColumn<>("property");
        ...
        property.setCellValueFactory(new MapValueFactory(Column7MapKey));
        property.setMinWidth(60);

        TableView tableView = new TableView<>(generateDataInMap());

        tableView.setEditable(false);
        tableView.getSelectionModel().setCellSelectionEnabled(true);
        tableView.getColumns().setAll(name, cash, deposit, coupon, houseNum, stock, property);
        ...
        property.setCellFactory(cellFactoryForMap);
